...
def recommend_portfolio(intent_request):
    ...
    if risk_level == "None":
        content += "If you have none risk tolerance, your portfolio will include 100% bonds (AGG), and 0% equities (SPY)"
    elif risk_level == "Low":
        content += "If you have a low risk tolerance, your portfolio will include 60% bonds (AGG), and 40% equities (SPY)"
    elif risk_level == "Medium":
        content += "If you have a medium risk tolerance, your portfolio will include 40% bonds (AGG), and 60% equities (SPY)"
    elif risk_level == "High":
        content += "If you have a high risk tolerance, your portfolio will include 20% bonds (AGG), and 80% equities (SPY)"
...
def validate_data(age, investment_amount, risk_level ):
    ...
    # Validate the user is under 65 years old
    if age is not None:
        age = parse_int(
            age
    ...
    # Validate the investment amount of greater than 5000.
    if investment_amount is not None:
        ...
        if investment_amount < 5000 :
            return build_validation_result(
                ...
                "please provide an amount greater than 5000 dollars",
            )

    # Validate the risk_level including 4 categories of None, Low, Medium, and High.
    if risk_level is not None:
        ...
        if risk_level not in ["none", "low", "medium", "high"] :
            return build_validation_result(
                False,
                "riskLevel",
                "please select one of the following risk levels : \"None\", \"Low\", \"Medium\", \"High\". "
                "please provide your preffered risk_level.",
            )
